TITLE Replace first e with Egg (P4-Q3.asm)
;--In english : You like english and esspresso , excellent !
;--In enggnglish : You like enggnglish and eggsspresso , eggxcellent !$
